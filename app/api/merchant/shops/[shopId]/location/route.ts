...
export async function PATCH(request: Request, ctx: RouteContext<"/api/merchant/shops/[shopId]/location">) {
  ...
  try {
    const shop = await storesApiFetch<Shop>(`/api/v1/merchant/shops/${shopId}/location`, {
      method: "PATCH",
