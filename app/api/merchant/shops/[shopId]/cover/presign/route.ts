...
export async function POST(request: Request, ctx: RouteContext<"/api/merchant/shops/[shopId]/cover/presign">) {
  ...
  try {
    const presign = await storesApiFetch<PresignResponse>(`/api/v1/merchant/shops/${shopId}/cover/presign`, {
      method: "POST",
